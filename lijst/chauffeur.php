...
//Maakt de array in 3 stukken voor de chauffeurs
...
<input type="button" onclick="tableToExcel('testTable', 'W3C Example Table', '<?php echo $chaufNumber . $dateNow ?>chauffeur.xls')"
